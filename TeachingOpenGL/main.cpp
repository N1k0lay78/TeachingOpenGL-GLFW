...
int main()
{
	...
	float vertices[] = {
	0.5f,  0.5f, 0.0f, 1.0f, 1.0f,  // верхняя правая                   0
	0.5f, -0.5f, 0.0f, 1.0f, 0.0f,  // нижняя правая                    1
	-0.5f, -0.5f, 0.0f, 0.0f, 0.0f,  // нижняя левая                    2
	-0.5f,  0.5f, 0.0f, 0.0f, 1.0f,  // верхняя левая                   3
	0.0f, 0.85f, 0.0f, 0.0f, 0.5f,   // верхняя посередине              4
	0.35f, 0.35f, 0.0f, 1.0f, 1.0f,    // правая верхняя часть окн      5
	0.35f, -0.35f, 0.0f, 1.0f, 0.0f,   // правая нижняя часть окна      6
	-0.35f, -0.35f, 0.0f, 0.0f, 0.0f,  // левая нижняя часть окна       7 
	-0.35f, 0.35, 0.0f, 0.0f, 1.0f,   // левая верхняя часть окна       8
	};
